            ...
            <button
              ...
              className={`relative flex items-center w-full gap-3 px-3 py-2 font-medium rounded-lg text-theme-sm group  ${
                openSubmenu?.type === menuType && openSubmenu?.index === index
                  ? "bg-primary-50 text-primary-500 dark:bg-primary-500/[0.12] dark:text-primary-400"
                          ...
                          <span
                            className={`ml-auto ${
                              isActive(subItem.path)
                                ...
                                : "bg-primary-50 group-hover:bg-primary-100 dark:bg-primary-500/15 dark:group-hover:bg-primary-500/20"
                            } block rounded-full px-2.5 py-0.5 text-xs font-medium uppercase text-primary-500 dark:text-primary-400 `}
                          >
                            new
                          </span>
                        )}
